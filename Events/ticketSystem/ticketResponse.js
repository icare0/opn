...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!guild.members.me.permissions.has(ManageChannels)) return interaction.reply({content: 'désoler je n ai pas les permissions pour', ephemeral: true}).catch(error => {return});
        try {
