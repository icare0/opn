    ...
    async execute(interaction) {
        ...
        logSchema.findOne({ Guild: guildId }, async (err, data) => {
            if (!data) {
                ...
                embed.setDescription("donné envoyer a la db")
                    .setColor("Green")
                    .setTimestamp();
            } else if (data) {
                ...
                embed.setDescription("ancienne donné envoyer a la db")
                    .setColor("Green")
                    .setTimestamp();
            }

            if (err) {
                embed.setDescription("quellque chose c'est mal passé contact le dev")
                    .setColor("Red")
                    .setTimestamp();
            }
