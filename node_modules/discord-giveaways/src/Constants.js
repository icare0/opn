...
exports.GiveawayMessages = {
    giveaway: '🎉🎉 **Giveaway** 🎉🎉',
    giveawayEnded: '🎉🎉 **GIVEAWAY FINIS** 🎉🎉',
    title: '{this.prize}',
    inviteToParticipate: 'réagis avec 🎉 pour participer!',
    winMessage: 'Bravo, {winners}! tu gagnes **{this.prize}**!\n{this.messageURL}',
    drawing: 'fin dans: {timestamp}',
    dropMessage: 'sois le premier à réagir avec 🎉 !',
    embedFooter: '{this.winnerCount} gagnant(s) au total',
    noWinner: 'giveaway annulé, pas de participant valide.',
    winners: 'gagnant:',
    endedAt: 'finis a',
    hostedBy: 'crée par: {this.hostedBy}'
};
